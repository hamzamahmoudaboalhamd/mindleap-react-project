...
const WorkingStep = () => {
  return (
    <div className="relative bg-cover bg-center py-12 bg-working-img">
      ...
      <div className="contanier relative mx-auto px-4 py-20">
        <motion.div
        ...
        >
          <div className="relative bg-white text-heroBg text-center rounded-lg p-6 flex-1 mx-2">
            ...
            <p className="my-2">
              Step 1 description goes hers. Lorem ipsum dolor sit amet,
              consectetur adipiscing elit
            </p>
          </div>
          <div className="relative bg-white text-heroBg text-center rounded-lg p-6 flex-1">
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-primary text-white size-14 rounded-full flex items-center justify-center">
              2
            </div>
